...
class AdapterJogadores : RecyclerView.Adapter<AdapterJogadores.ViewHolderJogadores>() {
    class ViewHolderJogadores(itemJogador: View) : RecyclerView.ViewHolder(itemJogador) {
